...
local MOUSE_LOCK_OFFSET = Vector3.new(2.75,0,5)
...
--KingedPawn
function MouseLockController:SetIsMouseLocked(isMouseLocked)
	self.isMouseLocked = isMouseLocked
...
function MouseLockController:GetMouseLockOffset()
	...
	if offsetValueObj and offsetValueObj:IsA("Vector3Value") then
		...
		offsetValueObj.Value = MOUSE_LOCK_OFFSET
	...
	return MOUSE_LOCK_OFFSET
end

function MouseLockController:UpdateMouseLockAvailability()
	local devAllowsMouseLock = PlayersService.LocalPlayer.DevEnableMouseLock
	local devMovementModeIsScriptable = PlayersService.LocalPlayer.DevComputerMovementMode == Enum.DevComputerMovementMode.Scriptable
	local userHasMouseLockModeEnabled = true --GameSettings.ControlMode == Enum.ControlMode.MouseLockSwitch
